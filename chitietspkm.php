...
$sql="SELECT id,hinh,tenhh,giakhuyenmai,mshh FROM sanphamkhuyenmai where id='$id'";
...
<div class="chitietsanpham">
					...
					<div class="chitietphai">
						...
						<div class="gia"><?php echo number_format( $row['giakhuyenmai']). 'vnđ' ?> </span> </a></div>
						<div class="SL">    
                        ...
                        <input type="hidden" name="giasanpham" value="<?php echo $row['giakhuyenmai'] ?>">
