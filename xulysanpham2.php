...
<body>
    ...
    <div class="xulydanhmuc">
        <div class="themdanhmuc">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <label for="">Id loại sản phẩm</label>
                <input type="text" name="idloai" value="2"><br><br>
                <label for="">Mã số hàng hóa</label>
        ...
        <div class="lietkedanhmuc">
            ...
            <?php
                $sql_select_sp=mysqli_query($con,"SELECT * FROM `hanghoa1` where idloai = 2 order by id DESC");
            ?>
            <table border="">
                    <tr>
                        <th>Thứ tự</th>
                    ...
                    <tr>
                        ...
                        <td><a href="?admin=sanpham2&xoa=<?php echo $row_sp['id']?>">Xóa</a> || <a href="?admin=sanpham2&capnhat_id=<?php echo $row_sp['id']?>">Cập nhật</a></td>
                    </tr>
                    <?php } ?>
            </table>
        </div>
